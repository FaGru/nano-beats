...
export const Sidebar: React.FC<SidebarProps> = ({}) => {
  ...
  return (
    <div
      className={`relative flex gap-16 flex-col bg-gray-900 ${isSidebarOpen ? 'w-48' : 'w-16'} transition-all duration-500 ease-in-out`}
    >
      <div className='p-2 justify-self-center self-center h-16'>
        <Link href='/'>
